		...
		<div id="sidebar" class="bg-light">
			...
			<div id="sidebar-field">
				<a href="faculty.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-users"> </i></div>  Examiner
				</a>
			</div>
		<?php endif; ?>
			<div id="sidebar-field">
				<!--<a href="student.php" class="sidebar-item text-dark">-->
				<!--		<div class="sidebar-icon"><i class="fa fa-users"> </i></div>  Aptitude Applicants List-->
				<!--</a>-->
			</div>
			<div id="sidebar-field">
				<a href="lap.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-users"> </i></div>  Lap Applicants List
				</a>
			</div>
			<div id="sidebar-field">
				<a href="quiz.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-list"> </i></div>  Aptitude Test
				</a>
			</div>
			<div id="sidebar-field">
				<a href="history.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-history"> </i></div>  Aptitude Records
				</a>
			</div>
			<?php else: ?>
			<div id="sidebar-field">
				<a href="student_quiz_list.php" class="sidebar-item text-dark">
						<div class="sidebar-icon"><i class="fa fa-list"> </i></div>  Aptitude List
				</a>
			</div>
		<?php endif; ?>
