...
<html>
	<head>
        ...
        ?>
		<title>Login | Lap Admin Quiz System</title>
	</head>

	<body id='login-body' class="bg-light">

        <div class="card col-md-6 offset-md-3 text-center bg-primary mb-4">
            <a href="https://lapapplication.info" class="text-center"  ><img src="../images/logo.png" style="width: 100px;"></a>
            <h3 class="he3-responsive text-white">Lap Admin Quiz System</h3>
        </div>
